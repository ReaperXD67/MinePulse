    ...
    <main className="plugin-page">
      <section className="plugin-hero" style={{ backgroundImage: "url('/voxel-network.png')" }}>
        ...
        <div className="container plugin-hero-content">
          <div className="plugin-signal"><PlugZap size={17} /><span>Bridge release 0.6.3</span><i>Paper / Spigot 1.20-1.21</i></div>
          ...
          <div className="inline-actions plugin-hero-actions">
            <a className="solid-button download-button" href="/downloads/KarixMCBridge-0.6.3.jar" download>
